...
This is a small list of steps in order to build libxvidcore into a msvc dll and/or lib file.
...
The project configurations support being built with various different windows SDK versions.
  ...
  (libxvidcore_with_latest_sdk.bat) which can be used to auto detect the newest available SDK
